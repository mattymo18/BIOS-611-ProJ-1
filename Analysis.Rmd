...
Pick ~ Weight + Height + combine40yd + combineBench + combineVert + combine3cone + combineShuttle + combineBroad + $\epsilon$.
This is done using multiple different regression techniques. Below is a table displaying the results of model. Models are assessed using RMSE of predicitons on test set. 
