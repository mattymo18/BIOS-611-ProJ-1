...
The Accuracy of the GLM Model with Height and Weight as Predictors is .56 on the validation set.  
...
```
The Accuracy of the GBM Model with Height and Weight as Predictors is .55 on the validation set.  
...
f1(DF.Split.Q3$validate$Gender, DF.Split.Q3$validate$glm2_pred)
```
